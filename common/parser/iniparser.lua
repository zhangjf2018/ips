...
=============================
require"iniparser"
ini_table = iniparser.get('big.ini', true)
...
function _M.get(filename, multikey_flag) --> (ini_table) or (nil,err)
...
function _M.set (ini_table, filename)
  f = io.open(filename,'w')
  if not f then return nil, "cannot open file: " .. filename end
  f:write('; Created by iniparser (http://luaforge.net/projects/iniparser/)\n\n')

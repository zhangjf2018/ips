...
local function init_data()
	...
	local data = {
		...
		out_trade_no = "20180201084841774435571",
		out_refund_no = tools.gen_ssn(),
	--out_refund_no = "20171205200803971813984",
		--device_info  = uid:sub(-32),
		--trade_no = "01000000002017112219104591",
...
local function main()
	...
	local url = conf.HOST .. "/pay/trade/refund"

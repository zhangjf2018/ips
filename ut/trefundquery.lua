...
local function init_data()
	...
	local data = {
		...
		refund_id     = "01000000002017120519200013",
		
		out_refund_no = "20171205202334348172900",
		
		trade_no      = "01000000002017120519200002",
		
		out_trade_no  = "20171205171042261208630",
...
local function main()
	...
	local url = conf.HOST .. "/pay/trade/refundquery"
